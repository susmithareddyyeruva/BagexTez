...
public class PickupCompletedOrdersAdapter <T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public PickupCompletedOrdersAdapter(Context context, List<T> myDataSet, RecyclerView recyclerViewCareers)
    {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_pickup_completed, parent, false);
