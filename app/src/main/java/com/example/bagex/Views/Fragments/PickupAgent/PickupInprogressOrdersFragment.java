...
import com.example.bagex.Views.Adapters.PickupAgent.PickupInProgressOrdersAdapter;
...
public class PickupInprogressOrdersFragment extends BaseFragment {
    ...
    private PickupInProgressOrdersAdapter pickupInProgressOrdersAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_pickup_inprogress_orders, container, false);
                ...
                .subscribe(new Subscriber<GetBookedOrdersResponeModel>() {
                    ...
                    public void onNext(final GetBookedOrdersResponeModel mResponse) {
                        ...
                        if (mResponse.getMessage().equalsIgnoreCase("Successful.")) {
                            ...
                            pickupInProgressOrdersAdapter = new PickupInProgressOrdersAdapter(context, listResults, recyclerView);
                            recyclerView.setAdapter(pickupInProgressOrdersAdapter);
