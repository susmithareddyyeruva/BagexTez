...
public class GetBookedOrdersResponeModel {
    ...
    public class Datum {
        ...
        @SerializedName("tStatusDescription")
        @Expose
        private String tStatusDescription;
        ...
        public String getTStatusDescription() {
            return tStatusDescription;
        }

        public void setTStatusDescription(String tStatusDescription) {
            this.tStatusDescription = tStatusDescription;
        }
