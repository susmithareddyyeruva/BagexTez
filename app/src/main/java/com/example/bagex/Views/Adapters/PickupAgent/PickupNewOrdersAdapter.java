...
public class PickupNewOrdersAdapter <T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PickupNewOrdersAdapter(Context context, List<T> myDataSet, RecyclerView recyclerViewCareers) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_pickup_new, parent, false);
