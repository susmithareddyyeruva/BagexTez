...
import com.example.bagex.Views.Adapters.PickupAgent.PickupCompletedOrdersAdapter;
...
public class PickupCompletedOrdersFragment extends BaseFragment {
    ...
    private PickupCompletedOrdersAdapter pickupCompletedOrdersAdapter;
    List<String> statusList = new ArrayList<>();




    public PickupCompletedOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview = inflater.inflate(R.layout.fragment_pickup_completed_orders, container, false);
                ...
                .subscribe(new Subscriber<GetBookedOrdersResponeModel>() {
                    ...
                    public void onNext(final GetBookedOrdersResponeModel mResponse) {
                        ...
                        if (mResponse.getMessage().equalsIgnoreCase("Successful.")) {
                            ...
                            pickupCompletedOrdersAdapter = new PickupCompletedOrdersAdapter(context, listResults, recyclerView);
                            recyclerView.setAdapter(pickupCompletedOrdersAdapter);
